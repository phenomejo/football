...
const columns = [
  ...
  { title: '', dataIndex: 'team.crestUrl', render: (text, record) => <img src={text} alt={record.team.id} onError={e => e.target.src = require('@/assets/image/not_found.png')} style={{ width: 30, height: 30 }} />, width: 40, fixed: 'left' },
